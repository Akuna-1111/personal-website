...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (phoneBtn) phoneBtn.addEventListener('click', function(e) {
        e.preventDefault();
    ...
    if (qqBtn) qqBtn.addEventListener('click', function(e) {
        e.preventDefault();
    ...
    if (zcoolBtn) zcoolBtn.addEventListener('click', function(e) {
        e.preventDefault();
